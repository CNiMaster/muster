...
describe('RuntimeToolRegistry 基础', () => {
  it('createBuiltinToolRegistry 注册 13 个内置工具', () => {
    ...
    expect(names).toEqual(
      ['ask_colleague', 'cancel_child_task', 'conclude_discussion', 'done', 'edit_file', 'list_files', 'notify_colleague', 'notify_host', 'read_file', 'run_command', 'start_discussion', 'submit_review', 'write_file'],
    );
  });
