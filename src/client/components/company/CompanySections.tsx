...
export type CompanySectionKey = 'conversation' | 'overview' | 'team' | 'projects' | 'activity' | 'settings' | 'attention' | 'evolution';

export function isCompanySectionKey(value: string | null): value is CompanySectionKey {
  return value === 'conversation' || value === 'overview' || value === 'team' || value === 'projects' || value === 'activity' || value === 'settings' || value === 'attention' || value === 'evolution';
}
