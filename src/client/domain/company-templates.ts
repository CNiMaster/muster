...
export const COMPANY_TEMPLATE_OPTIONS: CompanyTemplateOption[] = [
  { id: 'general', name: '通用项目工作台', category: 'engineering', description: '适合研究、运营和跨职能工作', roles: ['lead', 'specialist', 'reviewer'], mark: '通', colorToken: 'blue', maturity: 'ready', recommendedUse: '通用项目', version: 1 },
  { id: 'software', name: '软件研发工作台', category: 'engineering', description: '适合产品设计、开发和质量验证', roles: ['lead', 'product', 'engineer', 'reviewer'], mark: '码', colorToken: 'orange', maturity: 'ready', recommendedUse: '软件产品交付', version: 1 },
  { id: 'content', name: '内容创作工作台', category: 'creative', description: '适合策划、创作、编辑和发布', roles: ['lead', 'planner', 'creator', 'editor'], mark: '创', colorToken: 'green', maturity: 'ready', recommendedUse: '内容策划与发布', version: 1 },
  { id: 'novel', name: '长篇小说工作台', category: 'creative', description: '内置人物、情节和连续性协作流程', roles: ['lead', 'writer', 'character', 'plot', 'inspector'], mark: '文', colorToken: 'red', maturity: 'ready', recommendedUse: '长篇小说创作', version: 1 },
  { id: 'marketing', name: '品牌营销工作台', category: 'business', description: '适合市场调研、公关传播与增长推广', roles: ['lead', 'analyst', 'copywriter', 'pr_specialist'], mark: '销', colorToken: 'orange', maturity: 'ready', recommendedUse: '整合营销与品牌传播', version: 1 },
  { id: 'consulting', name: '行业咨询工作台', category: 'business', description: '适合行业研报、竞争分析与战略咨询', roles: ['lead', 'expert', 'data_analyst', 'editor'], mark: '询', colorToken: 'purple', maturity: 'ready', recommendedUse: '行业研究与战略建议', version: 1 },
  { id: 'visual', name: '图片制作工作台', category: 'creative', description: '适合插画、平面设计与 AI 绘图素材制作', roles: ['lead', 'designer', 'illustrator', 'ai_engineer', 'retoucher', 'reviewer'], mark: '图', colorToken: 'blue', maturity: 'needs_configuration', recommendedUse: '视觉素材制作', version: 1 },
  { id: 'video', name: '影视制作工作台', category: 'creative', description: '适合脚本、分镜、剪辑与成片制作', roles: ['lead', 'screenwriter', 'director', 'storyboard', 'editor', 'colorist', 'synthesist'], mark: '影', colorToken: 'red', maturity: 'needs_configuration', recommendedUse: '短视频与成片制作', version: 1 },
  { id: 'publishing', name: '编辑出版工作台', category: 'creative', description: '适合选题策划、编辑校对与出版发行', roles: ['lead', 'planner', 'editor', 'fact_checker', 'proofreader', 'layout'], mark: '版', colorToken: 'green', maturity: 'ready', recommendedUse: '内容编辑出版', version: 1 },
  { id: 'social', name: '社媒运营工作台', category: 'creative', description: '适合小红书、抖音、B 站等内容发布与账号运营', roles: ['lead', 'planner', 'copywriter', 'cover_designer', 'operator', 'analyst'], mark: '社', colorToken: 'orange', maturity: 'ready', recommendedUse: '社媒内容与账号运营', version: 1 },
];
