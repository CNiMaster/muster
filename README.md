...
- **智能体与人设**：工作台默认就位负责人与验收员；200+ 嵌入式 AI 专家人设按任务穿戴，智能体拥有独立 Agent Home、个人空间与分层记忆。
...
### 📋 项目与组织
- **项目主导**：所有实际工作归属于项目；小说题材域保留题材预设与章节流程。
...
2. 工作台自动就位负责人与验收员；可去「执行器中心」完成 CLI 绑定或 API 凭据（引导中也可直接完成）。
