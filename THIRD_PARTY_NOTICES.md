...
| InkOS (Narcooo/inkos) | https://github.com/Narcooo/inkos | AGPL-3.0 | 小说蓝图章节生产流水线（建档→写作→审计→结算→归档）、打法档案栏位与建档流程、伏笔账本生命周期与半衰期、受保护上下文分级、去 AI 味语义清理（story-deslop 技能）的理念参考；未复制任何代码与文本，全部白话重写（2026-09-06 蓝图领域档案批次+收尾批） | 2026-09-06 | 设计借鉴 |
